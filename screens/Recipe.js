 ...
 * @param {Object} props.route - The route object. Contains data passed between screens.
 * @param {Array<Object>} props.recipes - Array of recipe objects.
 * @param {Function} props.setRecipes - Function to set the recipes.
 *
 * @returns {React.Element} A screen displaying recipe details.
 */
function Recipe({ navigation, route, recipes, setRecipes }) {
    const { recipe } = route.params;

    /**
     * Function to toggle the bookmark status of a recipe
     *
